...
left_wall.transform = Matrix.translation(
    0, 0, 5) * Matrix.rotation_y(-math.pi/4) * Matrix.rotation_x(math.pi/2) * Matrix.scaling(10, 0.01, 10)
...
middle.material.pattern = StripePattern(color(1, 1, 1), color(0, 0, 0))
...
right.material.pattern = StripePattern(color(1, 1, 1), color(0, 0, 0))
...
save_canvas("output/ch10-1.ppm", canvas)
